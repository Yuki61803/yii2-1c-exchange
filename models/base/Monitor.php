...
class Monitor extends ActiveRecord
{
	...
	/**
	 * @inheritdoc
	 * @return \Yuki61803\exchange1c\models\Monitor|\yii\db\ActiveRecord
	 */
	public static function findOne($condition, $raise = false)
	{
		$model = parent::findOne($condition);
		if (!$model && $raise){
		    throw new \yii\web\HttpException(404, Yii::t('errors', "Model Yuki61803\\exchange1c\\models\\Monitor not found"));
		}else{
		    return $model;
		}
	}
	...
	/**
	 * @inheritdoc
	 * @return \Yuki61803\exchange1c\models\query\MonitorQuery the active query used by this AR class.
	 */
	public static function find()
	{
		return new \Yuki61803\exchange1c\models\query\MonitorQuery(get_called_class());
	}
